    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (loggedInCustomer != null) {
            try {
                ...
                e.printStackTrace();
                response.sendRedirect("error.jsp?message=An error occurred while retrieving your profile information.");
            }
        } else {
            response.sendRedirect("login.jsp?message=You must be logged in to view your profile.");
        }
    }
